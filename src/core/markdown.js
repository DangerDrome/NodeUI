                    ...
                    for (const node of nodesToTransform) {
                        ...
                        if (url.startsWith('local-video://')) {
                            try {
                                ...
                                node.type = 'html';
                                node.value = `<video controls loop muted autoplay width="100%"><source src="${blobUrl}"></video>`;
                            } catch (error) {
                            ...
                            if (youtubeMatch) {
                                ...
                                node.type = 'html';
                                node.value = `<video controls loop muted autoplay width="100%"><source src="${url}"></video>`;
                            }
                        }
                    }
                };
